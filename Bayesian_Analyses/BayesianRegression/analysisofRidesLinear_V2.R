...
# Parallel run - run instead of jags.model + burn-in
startTime = proc.time()
...
# The point of that was to show that the diagnostics are pretty bad
...
diagMCMC( codaSamples , parName="beta1" )
diagMCMC( codaSamples , parName="Var" )
# Don't need to worry about these, since they must be scaled back to beta0, beta1.
# Just check diagnostics for beta0, beta1
